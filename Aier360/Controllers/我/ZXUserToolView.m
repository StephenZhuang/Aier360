...
- (void)configureUI
{
    ...
    self.frame = CGRectMake(0, SCREEN_HEIGHT-52, SCREEN_WIDTH, 52);
...
- (UIButton *)chatButton
{
    if (!_chatButton) {
        ...
        [_chatButton setFrame:CGRectMake(15, 7, width, 38)];
        ...
        [_chatButton setBackgroundImage:[[UIImage imageNamed:@"mine_bt_addfriend"] stretchableImageWithLeftCapWidth:18 topCapHeight:9] forState:UIControlStateNormal];
...
- (UIButton *)addFriendButton
{
    if (!_addFriendButton) {
        ...
        CGFloat width = (SCREEN_WIDTH - 36) / 2;
        [_addFriendButton setFrame:CGRectMake(21+width, 7, width, 38)];
        ...
        [_addFriendButton setBackgroundImage:[[UIImage imageNamed:@"mine_bt_addfriend"] stretchableImageWithLeftCapWidth:18 topCapHeight:9] forState:UIControlStateNormal];
...
- (void)setIsFriend:(BOOL)isFriend
{
    ...
    if (isFriend) {
        [UIView animateWithDuration:0.2 animations:^{
            ...
            self.chatButton.frame = CGRectMake(15, 7, SCREEN_WIDTH - 30, 38);
        }];
    } else {
        [UIView animateWithDuration:0.2 animations:^{
            self.addFriendButton.alpha = 1;
            self.chatButton.frame = CGRectMake(15, 7, (SCREEN_WIDTH - 36) / 2 - 30, 38);
        }];
    }
}
