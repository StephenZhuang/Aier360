...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.imageView sd_setImageWithURL:[ZXImageUrlHelper imageUrlForSquareLabel:squareLabel.img type:ZXImageTypebig] placeholderImage:[UIImage imageNamed:@"placeholder"]];
